    ...
    <section className="max-w-[1280px] m-auto min-h-[calc(100vh-326px)] bg-[#ffffff] flex items-center gap-[58.5px] justify-center text-[#181818] text-justify  ">
      <div>
        ...
        <p className="mt-5 w-[800px] indent-10">
          ...
          Энэхүү төсөл нь одоогоор хөгжүүлэлтийн шатандаа явж байгаа бөгөөд
          удахгүй та бүхний өргөн хэрэглэдэг, ур чадварыг түгээн дэлгэрүүлэгч
          вэб сайт болно гэж итгэж байна.
        </p>
      </div>
    </section>
  );
